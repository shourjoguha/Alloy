...
class ProgramService:
    ...
    async def _apply_session_fallback(self, session_id: int, error_msg: str) -> None:
        ...
        async with async_session_maker() as db:
            ...
            failed_session.estimated_duration_minutes = parent_program.max_session_duration if parent_program and parent_program.max_session_duration else get_default_session_duration()
